...
:root {
  ...
  /* depth, light mode */
  --shadow-card:0 0.5px 1px rgba(11,13,18,.04), 0 4px 14px rgba(11,13,18,.06);
...
- Card: `--surface` fill, 1px `--line` border, `--radius-lg`, `--shadow-card` plus `--highlight-top`. Numbers in tabular Schibsted.
